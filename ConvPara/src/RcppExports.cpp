...
RcppExport SEXP _ConvPara_imageConvParallel(SEXP imgSEXP, SEXP kernelSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_ConvPara_imageConvParallel", (DL_FUNC) &_ConvPara_imageConvParallel, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_ConvPara(DllInfo *dll) {
